...
| **10** | Scoring: ⛔ **THE TOTAL IS NOT COMPUTED** | ⛔ **OWED — a hand tally** | ⚠ **"8 of 16 held" is PASS 6'S OWN HEADLINE, not the program's**, and passes 7 (9/12), 8 (9/11) and 9 (11/11) have landed since. Machine-readable verdict dictionaries exist for **passes 7, 8, 9 and L1 only** — 47 keys, **5 refuted** (A1, A3, B2, G2, N3). **Passes 4, 5 and 6 store no verdict dictionary**; a token count over their prose gives inconsistent numbers and was **discarded rather than quoted** (`PASS9_RESULTS.md §8.3`). What is owed is one arithmetic pass against each pass's own pre-registered letter list — **no new science, and it must be done before §10 is drafted.** The paper prints the refutations at the same size as the confirmations, including P2 refuted in the *opposite* direction (far side anti-collinear, 62.8° vs 45° uniform) |
