...
# This file was *autogenerated* from the file /mnt/c/Users/mercu/clawd/projects/Project Meridian/phase21/f1_definitive.sage
from sage.all_cmdline import *   # import sage library

_sage_const_70 = Integer(70); _sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_10 = Integer(10); _sage_const_4 = Integer(4); _sage_const_231 = Integer(231); _sage_const_5 = Integer(5); _sage_const_4452 = Integer(4452); _sage_const_150 = Integer(150); _sage_const_0p09170 = RealNumber('0.09170'); _sage_const_100 = Integer(100); _sage_const_9 = Integer(9); _sage_const_6 = Integer(6); _sage_const_3p0 = RealNumber('3.0'); _sage_const_5p0 = RealNumber('5.0'); _sage_const_0p776 = RealNumber('0.776'); _sage_const_0p436 = RealNumber('0.436')
import math
...
gv1_P2 = {_sage_const_1 : _sage_const_0 , _sage_const_2 : _sage_const_0 , _sage_const_3 : -_sage_const_10 , _sage_const_4 : _sage_const_231 , _sage_const_5 : -_sage_const_4452 }
...
beta = (_sage_const_1  - r) / (RR(_sage_const_5 )/_sage_const_3  + r)
...
beta_tree = RR(_sage_const_0p09170 )
a1a2_tree = (_sage_const_1  - _sage_const_5 *beta_tree/_sage_const_3 ) / (_sage_const_1  + beta_tree)
print("\nDoor 3 tree-level:")
...
print("\nDifference: %.6e" % diff)
print("Relative: %.4f%%" % float(diff/r * _sage_const_100 ))
...
print("")
print("Verification:")
for NY in [_sage_const_3 , _sage_const_9 ]:
    val = math.log(NY) / math.sqrt(NY - _sage_const_1 )
    print("  N_Y = %d: ln(N_Y)/sqrt(N_Y-1) = ln(%d)/sqrt(%d) = %.15f" % (NY, NY, NY-_sage_const_1 , val))
...
for i in range(_sage_const_1 ,_sage_const_6 ):
    v = vector(ZZ, [_sage_const_0 ,_sage_const_0 ,_sage_const_0 ,_sage_const_0 ,_sage_const_0 ,_sage_const_0 ])
    v[i] = -_sage_const_1   # E_i = 0*H + ... + (-1)*E_i in standard notation
    ...
    v2 = vector(ZZ, [_sage_const_0 ,_sage_const_0 ,_sage_const_0 ,_sage_const_0 ,_sage_const_0 ,_sage_const_0 ])
    v2[i] = _sage_const_1 
...
for i in range(_sage_const_1 ,_sage_const_6 ):
    for j in range(i+_sage_const_1 ,_sage_const_6 ):
        v = vector(ZZ, [_sage_const_1 ,_sage_const_0 ,_sage_const_0 ,_sage_const_0 ,_sage_const_0 ,_sage_const_0 ])
        v[i] = -_sage_const_1 
        v[j] = -_sage_const_1 
        neg_one_curves.append(("H-E_%d-E_%d" % (i,j), v))

# Type 3: 2H - E_1 - E_2 - E_3 - E_4 - E_5
v = vector(ZZ, [_sage_const_2 ,-_sage_const_1 ,-_sage_const_1 ,-_sage_const_1 ,-_sage_const_1 ,-_sage_const_1 ])
...
sum_p_sq = sum(p**_sage_const_2  for _, _, p in nonzero_pairing)
...
print("sum log|p_i| = %.6f" % sum(math.log(abs(p)) for _,_,p in nonzero_pairing if p != _sage_const_0 ))
print("n_charged * ln(N_Y) = %d * %.6f = %.6f" % (n_charged, math.log(_sage_const_3 ), n_charged*math.log(_sage_const_3 )))
...
beta_tree2 = RR(_sage_const_0p09170 )
a1a2_tree2 = float((_sage_const_1  - _sage_const_5 *beta_tree2/_sage_const_3 ) / (_sage_const_1  + beta_tree2))
...
# Difference:
print("\nDifference: %.6e (%.3f%%)" % (abs(a1a2_tree2 - a1a2_formula), abs(a1a2_tree2 - a1a2_formula)/a1a2_formula*_sage_const_100 ))
...
sin2_tree = _sage_const_3p0  / (_sage_const_3p0  + _sage_const_5p0  * _sage_const_0p776 )
sin2_exact = _sage_const_3p0  / (_sage_const_3p0  + _sage_const_5p0  * target)
...
print("  Difference from required: %.4f%%" % (abs(sin2_exact - _sage_const_0p436 )/_sage_const_0p436 *_sage_const_100 ))
