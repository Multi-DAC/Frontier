...
# This file was *autogenerated* from the file /mnt/c/Users/mercu/clawd/projects/Project Meridian/phase21/f1_computation_v2.sage
from sage.all_cmdline import *   # import sage library

_sage_const_70 = Integer(70); _sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_6 = Integer(6); _sage_const_8 = Integer(8); _sage_const_5 = Integer(5); _sage_const_11 = Integer(11); _sage_const_4 = Integer(4); _sage_const_9 = Integer(9); _sage_const_100 = Integer(100); _sage_const_0p0917 = RealNumber('0.0917'); _sage_const_10 = Integer(10); _sage_const_5p0 = RealNumber('5.0'); _sage_const_25 = Integer(25); _sage_const_12 = Integer(12)
import math
...
K = vector(ZZ, [-_sage_const_3 , _sage_const_1 , _sage_const_1 , _sage_const_1 , _sage_const_1 , _sage_const_1 ])
mK = -K  # anticanonical

# Hypercharge flux: c_1(L_Y) = 2H - E_1, with N_Y = c_1^2 = 4 - 1 = 3
LY = vector(ZZ, [_sage_const_2 , -_sage_const_1 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 ])

N_Y = dot_product(LY, LY)
K_sq = dot_product(K, K)
LY_mK = dot_product(LY, mK)
chi_S = _sage_const_8   # Euler characteristic of dP_5
...
for n in range(-_sage_const_5 , _sage_const_11 ):
    chi_n = _sage_const_1  + n*LY_mK/_sage_const_2  + n*n*N_Y/_sage_const_2 
...
# Casimir eigenvalues:
C2_SU3_adj = _sage_const_3        # C_2(8) of SU(3)
C2_SU3_fund = QQ(_sage_const_4 )/_sage_const_3   # C_2(3) of SU(3)
C2_SU2_adj = _sage_const_2        # C_2(3) of SU(2)
C2_SU2_fund = QQ(_sage_const_3 )/_sage_const_4   # C_2(2) of SU(2)
...
D3 = (_sage_const_3 , QQ(_sage_const_8 )/_sage_const_3 )  # (coeff of f(O), coeff of [f(L^5)+f(L^{-5})])
D2 = (_sage_const_2 , QQ(_sage_const_9 )/_sage_const_4 )  # Similarly for SU(2)

print("\nThreshold corrections:")
print("  Delta_3 = %s*f(O) + %s*[f(L^5)+f(L^{-5})]" % (D3[_sage_const_0 ], D3[_sage_const_1 ]))
print("  Delta_2 = %s*f(O) + %s*[f(L^5)+f(L^{-5})]" % (D2[_sage_const_0 ], D2[_sage_const_1 ]))
diff_O = D3[_sage_const_0 ] - D2[_sage_const_0 ]
diff_L = D3[_sage_const_1 ] - D2[_sage_const_1 ]
...
n = _sage_const_5 
chi_L5 = _sage_const_1  + n*LY_mK/_sage_const_2  + n*n*N_Y/_sage_const_2 
print("chi(dP_5, L_Y^5) = 1 + 5*%s/2 + 25*%s/2 = %s" % (str(LY_mK), str(N_Y), str(chi_L5)))

chi_Lm5 = _sage_const_1  + (-n)*LY_mK/_sage_const_2  + n*n*N_Y/_sage_const_2 
...
beta_exact = (_sage_const_1  - r) / (RR(_sage_const_5 )/_sage_const_3  + r)
...
print("  Relative difference: " + str(float(abs(beta_exact - RR(_sage_const_0p0917 ))/RR(_sage_const_0p0917 )*_sage_const_100 )) + "%")

# Check: a_1/a_2 from this beta
a1a2 = (_sage_const_1  - _sage_const_5 *beta_exact/_sage_const_3 ) / (_sage_const_1  + beta_exact)
...
for NY in range(_sage_const_2 , _sage_const_10 ):
    val = math.log(NY) / math.sqrt(NY - _sage_const_1 )
    beta_val = (_sage_const_1  - val) / (_sage_const_5p0 /_sage_const_3  + val)
    CS_percent = beta_val * _sage_const_100 
...
sigma = _sage_const_1  - _sage_const_5   # = -4 for dP_5
print("Signature sigma = 1 - 5 = " + str(sigma))

# A-hat genus:
A_hat = (sigma) / _sage_const_8 
...
int_ch2_Delta = -_sage_const_25  * N_Y
...
td_0 = _sage_const_1 
td_2_int = (K_sq + chi_S) / _sage_const_12   # = (4+8)/12 = 1
# td_1 integrated against ch_1 = 0 gives 0.

index_Delta = _sage_const_3  * td_2_int + _sage_const_0  + (-_sage_const_25  * N_Y) * td_0
...
chi_5O = _sage_const_5  * _sage_const_1   # 5 copies of trivial, chi(O)=1 each
chi_L5 = _sage_const_1  + _sage_const_5 *LY_mK/_sage_const_2  + _sage_const_25 *N_Y/_sage_const_2   # = 1 + 25/2 + 75/2 = 51
chi_Lm5 = _sage_const_1  + (-_sage_const_5 )*LY_mK/_sage_const_2  + _sage_const_25 *N_Y/_sage_const_2   # = 1 - 25/2 + 75/2 = 26
...
print("Parallel^2 = " + str(float(parallel_coeff**_sage_const_2  * K_sq)))
print("Check: parallel^2 + perp^2 = " + str(float(parallel_coeff**_sage_const_2  * K_sq + perp_sq)))
...
print("  C = " + str(beta_val * _sage_const_25 ) + " (for alpha_GUT ~ 1/25)")
print("")
print("From Door 3 tree-level: C/S = 0.0917")
print("This gives a_1/a_2 = " + str(float((_sage_const_1  - _sage_const_5 *_sage_const_0p0917 /_sage_const_3 )/(_sage_const_1  + _sage_const_0p0917 ))))
